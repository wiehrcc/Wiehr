...
class WiehrStorageModelAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ('📁 File', {
            'fields': ('file', 'preview_file', 'download_label', 'file_size', 'download_count'),
            'description': 'File is the real thing, released only to a valid key. '
                           ...
                           'Download Button Label renames the unlocked download button; empty '
                           'means "DOWNLOAD FULL PACK".'
        }),
        ('💵 Price & Contact', {
