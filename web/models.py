...
class WiehrStorageModel(models.Model):
    ...
    download_label = models.CharField(
        verbose_name='Download Button Label',
        max_length=40,
        blank=True,
        default='',
        help_text='What the unlocked download button says. Leave empty for '
                  '"DOWNLOAD FULL PACK". A font is not a pack — set it to '
                  '"DOWNLOAD FONT", "DOWNLOAD PROJECT", whatever the thing is.'
    )
    ...
    @property
    def download_button_label(self):
        return (self.download_label or '').strip() or 'DOWNLOAD FULL PACK'
